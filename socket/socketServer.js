...
class SocketServer {
    ...
    handleConnection(socket) {
        ...
        socket.on('send_image_message', this.handleSendImageMessage.bind(this, socket));
    ...
    getRoomUsers(roomId) {
        ...
        return Array.from(userIds).map(userId => this.connectedUsers.get(userId)?.user).filter(Boolean);
    }
